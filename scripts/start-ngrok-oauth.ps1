...
$facebookClientId = $env:OAUTH2_FACEBOOK_CLIENT_ID
$facebookClientSecretConfigured = -not [string]::IsNullOrWhiteSpace($env:OAUTH2_FACEBOOK_CLIENT_SECRET)
...
Write-Host "Facebook : $normalizedBaseUrl/login/oauth2/code/facebook"
Write-Host ""
...
Write-Host ("Facebook : client-id set = {0}, client-secret set = {1}" -f (-not [string]::IsNullOrWhiteSpace($facebookClientId)), $facebookClientSecretConfigured)
Write-Host ""
