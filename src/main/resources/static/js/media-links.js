window.applyMediaFacades = function() {
    const textContainers = document.querySelectorAll('.parse-media-links, .comment-text, article.content-section, .journal-post-text, .journal-post-content, .message-text, .report-text-content');
